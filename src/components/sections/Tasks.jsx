...
export default function Tasks() {
  ...
  const TaskCard = ({ task }) => (
    <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 h-[200px]  relative">
      ...
      <div className="flex justify-between items-center bottom-4 absolute w-[calc(100%-32px)]">
  ...
  const TaskSection = ({ title, tasks, badgeCount, showProgress }) => (
    <div className="space-y-4">
      ...
      {showProgress && <TaskProgressBar progress={60} />}
