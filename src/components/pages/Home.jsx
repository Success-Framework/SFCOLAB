import { BriefcaseBusiness, CheckCheck, LocateIcon, User, List, Calendar, Clock, ArrowUpRight, Users, Building2, MapPin, Target } from 'lucide-react'
              ...
              <div className='bg-[#1A1A1A] flex-1 items-center justify-center min-h-[330px] rounded-4xl p-7 space-y-6'>
                ...
                <div className='flex items-center justify-between pt-2 border-t border-white/10'>
                  <div className='flex items-center gap-3'>
                    ...
                    />
                    <div>
                      <p className='text-sm font-medium'>{content.team[0].name}</p>
                      <p className='text-xs text-gray-400'>{content.team[0].role}</p>
                    </div>
                  </div>
                </div>
              </div>
