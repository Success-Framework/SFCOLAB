import { BriefcaseBusiness, CheckCheck, LocateIcon, User, Filter, Plus, MessageSquare, ThumbsUp, Tag, ArrowUpRight, Calendar, Users } from 'lucide-react'
                ...
                <div className='flex w-full justify-between items-start'>
                  <div className="flex items-center gap-3">
                    <div className="h-12 w-12 rounded-full overflow-hidden bg-zinc-700">
                      <img src={content.author.avatar} alt={content.author.name} className="h-full w-full object-cover" />
                    </div>
